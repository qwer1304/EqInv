...
def main(args):
    ...
    count_c0_o = [memory_images.imgs[j][label] // 2 for j in env_ref_set[anchor].tolist()].count(0)
    count_c1_o = [memory_images.imgs[j][label] // 2 for j in env_ref_set[anchor].tolist()].count(1)
